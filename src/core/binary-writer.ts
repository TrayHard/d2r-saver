...
export class BitWriter {
  ...
  writeBytes(bytes: ArrayLike<number>, numberOfBits: number = (bytes as Uint8Array).length * 8): this {
  ...
  writeUInt8(value: number, numberOfBits = 8): this {
  ...
  writeUInt16(value: number, numberOfBits = 16): this {
  ...
  writeUInt32(value: number, numberOfBits = 32): this {
  ...
  writeChar(ch: string): this {
    ...
    if (!entry) throw new Error(`writeChar: unsupported character '${ch}'`);
